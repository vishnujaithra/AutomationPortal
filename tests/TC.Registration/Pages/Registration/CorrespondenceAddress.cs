...
namespace TC.ProviderDataEntry.Pages.Registration
{
    public class CorrespondenceAddress:BasePage
    {
        ...
        public IWebElement FirstName
        {
            get
            {
                return WebDriver.FindElement(By.Id($"ctl00_MainContent_ucCorrespondenceAddress_{RegID}_ucAddress_txtFirst"));
            }
        }
        public IWebElement MiddleName
        {
            get
            {
                return WebDriver.FindElement(By.Id($"ctl00_MainContent_ucCorrespondenceAddress_{RegID}_ucAddress_txtMiddle"));
            }
        }
        public IWebElement LastName
        {
            get
            {
                return WebDriver.FindElement(By.Id($"ctl00_MainContent_ucCorrespondenceAddress_{RegID}_ucAddress_txtLast"));
            }
        }
        public IWebElement SameLocation
        {
            get
            {
                return WebDriver.FindElement(By.Id($"ctl00_MainContent_ucCorrespondenceAddress_{RegID}_prov_Same"));
            }
        }
        public IWebElement OverrideAddressValidation
        {
            get
            {
                return WebDriver.FindElement(By.Id($"ctl00_MainContent_ucCorrespondenceAddress_{RegID}_prov_override"));
            }
        }
        ...
        public IWebElement Address1
        {
            get
            {
                return WebDriver.FindElement(By.Id($"ctl00_MainContent_ucCorrespondenceAddress_{RegID}_ucAddress_txtAddress1"));
            }
        }
        public IWebElement Address2
        {
            get
            {
                return WebDriver.FindElement(By.Id($"ctl00_MainContent_ucCorrespondenceAddress_{RegID}_ucAddress_txtAddress2"));
            }
        }
        public IWebElement City
        {
            get
            {
                return WebDriver.FindElement(By.Id($"ctl00_MainContent_ucCorrespondenceAddress_{RegID}_ucAddress_txtCity"));
            }
        }
        public IWebElement ZipCode
        {
            get
            {
                return PageHelper.FindElement(webDriver, By.Id($"ctl00_MainContent_ucCorrespondenceAddress_{RegID}_ucAddress_nbZipFirst5"), null);
            }
        }
        public IWebElement ZipCodeExt
        {
            get
            {
                return PageHelper.FindElement(webDriver, By.Id($"ctl00_MainContent_ucCorrespondenceAddress_{RegID}_ucAddress_nbZipLast4"), null);
            }
        }
        public IWebElement Phone1
        {
            get
            {
                return PageHelper.FindElement(webDriver, By.Id($"ctl00_MainContent_ucCorrespondenceAddress_{RegID}_ucAddress_txtPhoneNo1"), null);
            }
        }
        public IWebElement Phone1Ext
        {
            get
            {
                return PageHelper.FindElement(webDriver, By.Id($"ctl00_MainContent_ucCorrespondenceAddress_{RegID}_ucAddress_txtPhoneExt1"), null);
            }
        }
        public IWebElement Phone2
        {
            get
            {
                return WebDriver.FindElement(By.Id($"ctl00_MainContent_ucCorrespondenceAddress_{RegID}_ucAddress_txtPhoneNo2"));
            }
        }
        public IWebElement Phone2Ext
        {
            get
            {
                return WebDriver.FindElement(By.Id($"ctl00_MainContent_ucCorrespondenceAddress_{RegID}_ucAddress_txtPhoneExt2"));
            }
        }
        public IWebElement EmailAddress1
        {
            get
            {
               return  PageHelper.FindElement(webDriver, By.Id($"ctl00_MainContent_ucCorrespondenceAddress_{RegID}_ucAddress_txtEmail1"), null);
            }
        }
        ...
        {
            IWebElement PracticeTypeElement = PageHelper.FindElement(webDriver, By.Id($"ctl00_MainContent_ucCorrespondenceAddress_{RegID}_ucAddress_ddlState"), null);
        ...
        {
            IWebElement PracticeTypeElement = WebDriver.FindElement(By.Id($"ctl00_MainContent_ucCorrespondenceAddress_{RegID}_ucAddress_ddlCounty"));
            SelectElement PracticeTypeElementDropDown = new SelectElement(PracticeTypeElement);
            PracticeTypeElementDropDown.SelectByText(item);
        }
