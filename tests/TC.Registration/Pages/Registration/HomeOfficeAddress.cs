...
namespace TC.ProviderDataEntry.Pages.Registration
{
    public class HomeOfficeAddress:BasePage
    {
        ...
        public IWebElement FirstName
        {
            get
            {
                return webDriver.CreateSmartElement(By.Id($"ctl00_MainContent_ucHomeOfficeAddress_{RegID}_ucAddress_txtFirst")).Element;
            }
        }
        public IWebElement MiddleName
        {
            get
            {
                return webDriver.CreateSmartElement(By.Id($"ctl00_MainContent_ucHomeOfficeAddress_{RegID}_ucAddress_txtMiddle")).Element;
            }
        }
        public IWebElement LastName
        {
            get
            {
                return webDriver.CreateSmartElement(By.Id($"ctl00_MainContent_ucHomeOfficeAddress_{RegID}_ucAddress_txtLast")).Element;
            }
        }
        ...
        public IWebElement Address1
        {
            get
            {
                return webDriver.CreateSmartElement(By.Id($"ctl00_MainContent_ucHomeOfficeAddress_{RegID}_ucAddress_txtAddress1")).Element;
            }
        }
        public IWebElement Address2
        {
            get
            {
                return webDriver.CreateSmartElement(By.Id($"ctl00_MainContent_ucHomeOfficeAddress_{RegID}_ucAddress_txtAddress2")).Element;
            }
        }
        public IWebElement City
        {
            get
            {
                return webDriver.CreateSmartElement(By.Id($"ctl00_MainContent_ucHomeOfficeAddress_{RegID}_ucAddress_txtCity")).Element;
            }
        }
        public IWebElement ZipCode
        {
            get
            {
                return webDriver.CreateSmartElement(By.Id($"ctl00_MainContent_ucHomeOfficeAddress_{RegID}_ucAddress_nbZipFirst5")).Element;
            }
        }
        public IWebElement ZipCodeExt
        {
            get
            {
                return webDriver.CreateSmartElement(By.Id($"ctl00_MainContent_ucHomeOfficeAddress_{RegID}_ucAddress_nbZipLast4")).Element;
            }
        }
        public IWebElement Phone1
        {
            get
            {
                return webDriver.CreateSmartElement(By.Id($"ctl00_MainContent_ucHomeOfficeAddress_{RegID}_ucAddress_txtPhoneNo1")).Element;
            }
        }
        public IWebElement Phone1Ext
        {
            get
            {
                return webDriver.CreateSmartElement(By.Id($"ctl00_MainContent_ucHomeOfficeAddress_{RegID}_ucAddress_txtPhoneExt1")).Element;
            }
        }
        public IWebElement Phone2
        {
            get
            {
                return webDriver.CreateSmartElement(By.Id($"ctl00_MainContent_ucHomeOfficeAddress_{RegID}_ucAddress_txtPhoneNo2")).Element;
            }
        }
        public IWebElement Phone2Ext
        {
            get
            {
                return webDriver.CreateSmartElement(By.Id($"ctl00_MainContent_ucHomeOfficeAddress_{RegID}_ucAddress_txtPhoneExt2")).Element;
            }
        }
        ...
        public IWebElement Email
        {
            get
            {
                return webDriver.CreateSmartElement(By.Id($"ctl00_MainContent_ucHomeOfficeAddress_{RegID}_ucAddress_txtEmail1")).Element;
            }
        }
        ...
        public IWebElement SamePracticeLocation
        {
            get
            {
                return webDriver.CreateSmartElement(By.Id($"ctl00_MainContent_ucHomeOfficeAddress_{RegID}_prov_Same")).Element;
            }
        }
        ...
        {
            IWebElement PracticeTypeElement = webDriver.CreateSmartElement(By.Id($"ctl00_MainContent_ucHomeOfficeAddress_{RegID}_ucAddress_ddlState")).Element;
        ...
        {
            IWebElement PracticeTypeElement = webDriver.CreateSmartElement(By.Id($"ctl00_MainContent_ucHomeOfficeAddress_{RegID}_ucAddress_ddlCounty")).Element;
            SelectElement PracticeTypeElementDropDown = new SelectElement(PracticeTypeElement);
            PracticeTypeElementDropDown.SelectByText(item);
        }
        #endregion
