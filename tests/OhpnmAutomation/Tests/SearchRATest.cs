...
namespace OhpnmAutomation.Tests
{
    ...
    public class SearchRATest : BaseFeatureFixture
    {
        ...
        {
            Models.SearchRA.SearchRA searchRA = (Models.SearchRA.SearchRA)DataRepository.GetAutomationData("SearchRA");
            ...
            SearchRAPage searchRAPage = new SearchRAPage(TestWebDriver);
