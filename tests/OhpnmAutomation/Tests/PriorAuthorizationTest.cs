...
namespace PriorAuthorization.Tests
{
    ...
    public class PriorAuthorizationTest : BaseFeatureFixture
    {
        ...
        {
            OhpnmAutomation.Models.PA.DentalPA dentalPA = (DentalPA)DataRepository.GetAutomationData("DentalPA");
        ...
        public void DentalPA_Save()
        {
            ...
            {
                TestContext.WriteLine($"PA request has been saved with Patient Tracking Number::{dentalPA.DentalRecipientInformation.PatientTrackingNumber}");
            }
        }
            ...
            if (lblDentalProcMessage.Displayed && lblDentalProcMessage.Text.Equals("Procedure code is invalid"))
            {
                ...
                if (procedureCodeOutput.Displayed)
                {
                    if (!procedureCodeOutput.Text.Equals("No data found."))
                        ...
                        Assert.Fail("no procedure code data found with the given code.");
                }
            }
