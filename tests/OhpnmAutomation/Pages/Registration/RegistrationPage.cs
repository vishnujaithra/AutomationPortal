...
namespace OhpnmAutomation.Pages.Registration
{
    public class RegistrationPage : BasePage
    {
        ...
        public By BtnNextLocator
        {
            get
            {
                return By.Id("ctl00_MainContent_ucRegistrationNavigation_btnSaveNext");
            }
        }
        ...
        public IWebElement More
        {
            get
            {
                return PageHelper.FindElement(webDriver, By.XPath($"//a[@data-toggle='collapse' and @data-target='#collapsible' and text()='More...']"), null);

            }
        }
        public IWebElement Less
        {
            get
            {
                return PageHelper.FindElement(webDriver, By.XPath($"//a[@data-toggle='collapse' and @data-target='#collapsible' and text()='Less...']"), null);
        ...
        public bool IsPanelExpandedByStyle(IWebDriver driver)
        {
            IWebElement panel = driver.FindElement(By.Id("collapsible"));
            string style = panel.GetAttribute("style");
            return style != null && !style.Contains("height: 0px");
        }

        public IWebElement WaitForApplicationCompleteButton(IWebDriver webDriver, TimeSpan timeout)
        {
            WebDriverWait wait = new WebDriverWait(webDriver, timeout);
            By locator = By.XPath("//input[@type='submit' and @value='Application Complete' and contains(@id, 'btnAction')]");
