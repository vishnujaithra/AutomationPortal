...
namespace OhpnmAutomation.Pages.Registration
{
    public class PrimaryAddressService : BasePage
    {
        ...
        public IWebElement PrimaryContactName
        {
            get
            {
                return WebDriver.FindElement(By.Id($"ctl00_MainContent_ucPrimaryServiceAddress_{RegID}_txtProviderName"));
            }
        }
        public IWebElement Address1
        {
            get
            {
                return WebDriver.FindElement(By.Id($"ctl00_MainContent_ucPrimaryServiceAddress_{RegID}_ucAddress_txtAddress1"));
            }
        }
        public IWebElement Address2
        {
            get
            {
                return WebDriver.FindElement(By.Id($"ctl00_MainContent_ucPrimaryServiceAddress_{RegID}_ucAddress_txtAddress2"));
            }
        }
        public IWebElement City
        {
            get
            {
                return WebDriver.FindElement(By.Id($"ctl00_MainContent_ucPrimaryServiceAddress_{RegID}_ucAddress_txtCity"));
            }
        }
        public IWebElement ZipCode
        {
            get
            {
                return PageHelper.FindElement(webDriver,By.Id($"ctl00_MainContent_ucPrimaryServiceAddress_{RegID}_ucAddress_nbZipFirst5"),null);
            }
        }
        public IWebElement ZipCodeExt
        {
            get
            {
                return PageHelper.FindElement(webDriver, By.Id($"ctl00_MainContent_ucPrimaryServiceAddress_{RegID}_ucAddress_nbZipLast4"), null);
            }
        }
        public IWebElement Phone1
        {
            get
            {
                return PageHelper.FindElement(webDriver, By.Id($"ctl00_MainContent_ucPrimaryServiceAddress_{RegID}_ucAddress_txtPhoneNo1"), null);
            }
        }
        public IWebElement Phone1Ext
        {
            get
            {
                return WebDriver.FindElement(By.Id($"ctl00_MainContent_ucPrimaryServiceAddress_{RegID}_ucAddress_txtPhoneExt1"));
            }
        }
        public IWebElement Phone2
        {
            get
            {
                return WebDriver.FindElement(By.Id($"ctl00_MainContent_ucPrimaryServiceAddress_{RegID}_ucAddress_txtPhoneNo2"));
            }
        }
        public IWebElement Phone2Ext
        {
            get
            {
                return WebDriver.FindElement(By.Id($"ctl00_MainContent_ucPrimaryServiceAddress_{RegID}_ucAddress_txtPhoneExt2"));
            }
        }
        public IWebElement EmailAddress1
        {
            get
            {
                return WebDriver.FindElement(By.Id($"ctl00_MainContent_ucPrimaryServiceAddress_{RegID}_ucAddress_txtEmail1"));
            }
        }
        ...
        {
            IWebElement PracticeTypeElement = WebDriver.FindElement(By.Id($"ctl00_MainContent_ucPrimaryServiceAddress_{RegID}_ucAddress_ddlState"));
        ...
        {
            IWebElement PracticeTypeElement = WebDriver.FindElement(By.Id($"ctl00_MainContent_ucPrimaryServiceAddress_{RegID}_ucAddress_ddlCounty"));
            SelectElement PracticeTypeElementDropDown = new SelectElement(PracticeTypeElement);
            PracticeTypeElementDropDown.SelectByText(item);
        }
